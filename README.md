...
1. From the **Cordova Facebook Connect Plugin** folder copy the contents of the **src/ios** folder into your app in Xcode (usually in the **Plugins** folder group). Make sure it is added as a "group" (yellow folder)
